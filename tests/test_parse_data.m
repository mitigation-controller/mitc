...
classdef test_parse_data < matlab.unittest.TestCase
   ...
   methods (Test)         
       ...
       function testVariableNames(testCase, dataDouble, dataCell)           
           ...
           expVars = {'durationActivitiesTotal', 'nActivities',...
               'sharedActivityDurations', 'nSharedActivities',...
               'durationActivitiesCorrelation', 'durationActivitiesNoCorrelation',...
       ...
       function testRemoveNan(testCase, dataDouble, dataCell)
           Data = parse_data(dataDouble, dataCell);
           nNan = sum(isnan(Data.durationActivitiesTotal(:)));
